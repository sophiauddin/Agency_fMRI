...
## Choosing appropriate ROIs

### Starting point: guide papers

The following papers (from Shoham) were used as a guide. 
...
### Important areas ID'd in guide papers and in the literature they cite:



## Creating meta-analyses with Neurosynth

After the above areas were identified via the literature, they were used to generate meta-analyses using 
