...
+ <span style="color:red">Paracingulate cortex - searched but no results in Neurosynth</span>  
+ Caudate
+ Precuneus
+ VMPFC
+ VLPFC
...
+ Anterior insula
+ Nucleus accumbens
+ <span style="color:red">Ventral tegmental area - searched but no results in Neurosynth</span>
...
+ For each ROI, use R to perform a paired t-test between agency and non-agency (n=38 usable subjects)
